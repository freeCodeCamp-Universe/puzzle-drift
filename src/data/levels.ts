...
const LEVEL_HINTS: Record<number, LevelHint[]> = {
  ...
  27: composeLevelHints([
    ...
    'The block and plate come before the key and final lock.',
  ...
  28: composeLevelHints([
    'Start by using the portal to reach the key side.',
    'Portal access comes before the key, and the key comes before the lock.',
    'The spike row punishes the direct-looking shortcut.',
    'Reach the key from the safer side, then return to spend it at the exit lock.',
  ]),
